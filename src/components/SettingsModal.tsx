...
import { Modal, Box, Typography, Button, FormControl, Select, MenuItem, Switch, SelectChangeEvent, FormControlLabel } from '@mui/material';
    ...
    return (
        <Modal open={open} onClose={onClose}>
            ...
            >
                ...
                <Box sx={{ mt: 2 }}>
                    <Typography sx={{ mt: 4, fontWeight: 'bold' }}>{t('settings.themeMode')}</Typography>
                ...
                <Typography sx={{ mt: 4, fontWeight: 'bold' }}>{t('settings.language')}</Typography>
                <Box sx={{ mt: 2, ml: 1 }}>
                    <FormControl fullWidth>
                        <Select
                            value={language}
                ...
                <Box sx={{ mt: 3, textAlign: 'right' }}>
                    <Button onClick={onClose} variant="contained">{t('settings.close')}</Button>
                </Box>
            </Box>
        </Modal>
    );
